...
data class Veglenkesegment (
    ...
    val startnode: kotlin.String,

    @get:JsonProperty("sluttnode")
    val sluttnode: kotlin.String,

    @get:JsonProperty("referanse")
    val referanse: kotlin.String,

    @get:JsonProperty("type")
    val type: Veglenkesegment.Type,

    @get:JsonProperty("detaljnivå")
    val detaljnivå: Veglenkesegment.Detaljnivå,

    @get:JsonProperty("typeVeg")
    val typeVeg: Veglenkesegment.TypeVeg,

    @get:JsonProperty("typeVeg_sosi")
    val typeVegSosi: Veglenkesegment.TypeVegSosi,

    @get:JsonProperty("målemetode")
    val målemetode: Veglenkesegment.Målemetode,
