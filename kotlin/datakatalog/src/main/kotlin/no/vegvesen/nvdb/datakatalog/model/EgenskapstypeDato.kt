...
data class EgenskapstypeDato (
    ...
    @SerialName(value = "egenskapstype") @Required override val egenskapstype: EgenskapstypeDato.Egenskapstype,
    ...
    @SerialName(value = "viktighet") @Required override val viktighet: EgenskapstypeDato.Viktighet,
    ...
    @SerialName(value = "standardverdi") val standardverdi: java.time.LocalDate? = null,

    @SerialName(value = "min_anbefalt") val minAnbefalt: java.time.LocalDate? = null,

    @SerialName(value = "maks_anbefalt") val maksAnbefalt: java.time.LocalDate? = null,
