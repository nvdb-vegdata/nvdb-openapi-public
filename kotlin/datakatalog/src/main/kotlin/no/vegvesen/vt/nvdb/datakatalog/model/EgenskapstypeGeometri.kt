...
data class EgenskapstypeGeometri (
    ...
    @Json(name = "dimensjoner")
    val dimensjoner: kotlin.Int,

    @Json(name = "geometritype")
    val geometritype: EgenskapstypeGeometri.Geometritype,
    ...
    enum class Geometritype(val value: kotlin.String) {
        ...
        @Json(name = "FLERELINJE") FLERELINJE("FLERELINJE"),
        @Json(name = "FLEREPUNKT") FLEREPUNKT("FLEREPUNKT"),
        @Json(name = "FLEREPOLYGON") FLEREPOLYGON("FLEREPOLYGON"),
        @Json(name = "KOMPLEKS") KOMPLEKS("KOMPLEKS"),
