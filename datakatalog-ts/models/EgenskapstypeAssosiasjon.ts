...
export function EgenskapstypeAssosiasjonFromJSON(json: any): EgenskapstypeAssosiasjon {
    return EgenskapstypeAssosiasjonFromJSONTyped(json, false);
}

export function EgenskapstypeAssosiasjonFromJSONTyped(json: any, ignoreDiscriminator: boolean): EgenskapstypeAssosiasjon {
    ...
    return {
        ...
        'vegobjekttypeid': !exists(json, 'vegobjekttypeid') ? undefined : json['vegobjekttypeid'],
        ...
        'assosiasjonskrav': !exists(json, 'assosiasjonskrav') ? undefined : json['assosiasjonskrav'],
        'assosiasjonskravkommentar': !exists(json, 'assosiasjonskravkommentar') ? undefined : json['assosiasjonskravkommentar'],
    };
}

export function EgenskapstypeAssosiasjonToJSON(value?: EgenskapstypeAssosiasjon | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
