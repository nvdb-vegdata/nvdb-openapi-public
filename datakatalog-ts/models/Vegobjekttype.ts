...
export function VegobjekttypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): Vegobjekttype {
    ...
    return {
        ...
        'stedfesting': !exists(json, 'stedfesting') ? undefined : StedfestingFromJSON(json['stedfesting']),
        ...
        'hovedkategori': !exists(json, 'hovedkategori') ? undefined : json['hovedkategori'],
        'tidsromRelevant': json['tidsrom_relevant'],
        'konnekteringslenkeOk': !exists(json, 'konnekteringslenke_ok') ? undefined : json['konnekteringslenke_ok'],
        'abstraktType': json['abstrakt_type'],
        'avledet': json['avledet'],
        'mHaMor': json['må_ha_mor'],
        'enVersjon': json['en_versjon'],
        'tilleggsinformasjon': !exists(json, 'tilleggsinformasjon') ? undefined : json['tilleggsinformasjon'],
        'kategorier': ((json['kategorier'] as Array<any>).map(VegobjektKategoriFromJSON)),
        'egenskapstyper': !exists(json, 'egenskapstyper') ? undefined : ((json['egenskapstyper'] as Array<any>).map(EgenskapstypeFromJSON)),
        'relasjonstyper': !exists(json, 'relasjonstyper') ? undefined : RelasjonstyperFromJSON(json['relasjonstyper']),
...
export function VegobjekttypeToJSON(value?: Vegobjekttype | null): any {
    ...
    return {
        ...
        'egenskapstyper': value.egenskapstyper === undefined ? undefined : ((value.egenskapstyper as Array<any>).map(EgenskapstypeToJSON)),
