...
export type EgenskapstypeStedfestingStedfestingstypeEnum = typeof EgenskapstypeStedfestingStedfestingstypeEnum[keyof typeof EgenskapstypeStedfestingStedfestingstypeEnum];
...
export type EgenskapstypeStedfestingGeometritypeEnum = typeof EgenskapstypeStedfestingGeometritypeEnum[keyof typeof EgenskapstypeStedfestingGeometritypeEnum];
...
export type EgenskapstypeStedfestingKjrefeltRelevantEnum = typeof EgenskapstypeStedfestingKjrefeltRelevantEnum[keyof typeof EgenskapstypeStedfestingKjrefeltRelevantEnum];
...
export type EgenskapstypeStedfestingSideposisjonRelevantEnum = typeof EgenskapstypeStedfestingSideposisjonRelevantEnum[keyof typeof EgenskapstypeStedfestingSideposisjonRelevantEnum];
...
export type EgenskapstypeStedfestingVegnettsajourholdSplittEnum = typeof EgenskapstypeStedfestingVegnettsajourholdSplittEnum[keyof typeof EgenskapstypeStedfestingVegnettsajourholdSplittEnum];
...
export function EgenskapstypeStedfestingFromJSON(json: any): EgenskapstypeStedfesting {
    return EgenskapstypeStedfestingFromJSONTyped(json, false);
}

export function EgenskapstypeStedfestingFromJSONTyped(json: any, ignoreDiscriminator: boolean): EgenskapstypeStedfesting {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        ...EgenskapstypeFromJSONTyped(json, ignoreDiscriminator),
        'stedfestingstype': !exists(json, 'stedfestingstype') ? undefined : json['stedfestingstype'],
        'geometritype': !exists(json, 'geometritype') ? undefined : json['geometritype'],
        'overlappOk': !exists(json, 'overlapp_ok') ? undefined : json['overlapp_ok'],
        'kjrefeltRelevant': !exists(json, 'kjørefelt_relevant') ? undefined : json['kjørefelt_relevant'],
        'sideposisjonRelevant': !exists(json, 'sideposisjon_relevant') ? undefined : json['sideposisjon_relevant'],
        'innenforMor': !exists(json, 'innenfor_mor') ? undefined : json['innenfor_mor'],
        'vegnettsajourholdSplitt': !exists(json, 'vegnettsajourhold_splitt') ? undefined : json['vegnettsajourhold_splitt'],
        'overlappsautomatikk': !exists(json, 'overlappsautomatikk') ? undefined : json['overlappsautomatikk'],
        'retningRelevant': !exists(json, 'retning_relevant') ? undefined : json['retning_relevant'],
    };
}

export function EgenskapstypeStedfestingToJSON(value?: EgenskapstypeStedfesting | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
