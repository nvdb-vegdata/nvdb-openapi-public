...
export function EgenskapstypeFlyttallenumFromJSON(json: any): EgenskapstypeFlyttallenum {
    return EgenskapstypeFlyttallenumFromJSONTyped(json, false);
}

export function EgenskapstypeFlyttallenumFromJSONTyped(json: any, ignoreDiscriminator: boolean): EgenskapstypeFlyttallenum {
    ...
    return {
        ...
        'tillatteVerdier': ((json['tillatte_verdier'] as Array<any>).map(EnumverdiFlyttallFromJSON)),
    };
}

export function EgenskapstypeFlyttallenumToJSON(value?: EgenskapstypeFlyttallenum | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'tillatte_verdier': ((value.tillatteVerdier as Array<any>).map(EnumverdiFlyttallToJSON)),
    };
}
