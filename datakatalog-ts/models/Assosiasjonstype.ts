...
export function AssosiasjonstypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): Assosiasjonstype {
    ...
    return {
        ...
        'innhold': !exists(json, 'innhold') ? undefined : AssosiasjonstypeListeInnholdFromJSON(json['innhold']),
        'type': !exists(json, 'type') ? undefined : AssosiasjonstypeVegobjekttypeFromJSON(json['type']),
    };
}
