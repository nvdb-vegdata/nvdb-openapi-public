...
export function EgenskapstypeStrukturFromJSON(json: any): EgenskapstypeStruktur {
    return EgenskapstypeStrukturFromJSONTyped(json, false);
}

export function EgenskapstypeStrukturFromJSONTyped(json: any, ignoreDiscriminator: boolean): EgenskapstypeStruktur {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        ...EgenskapstypeFromJSONTyped(json, ignoreDiscriminator),
        'egenskapstyper': ((json['egenskapstyper'] as Array<any>).map(EgenskapstypeFromJSON)),
    };
}

export function EgenskapstypeStrukturToJSON(value?: EgenskapstypeStruktur | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'egenskapstyper': ((value.egenskapstyper as Array<any>).map(EgenskapstypeToJSON)),
    };
}
