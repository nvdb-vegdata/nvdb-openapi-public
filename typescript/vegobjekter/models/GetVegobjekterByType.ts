...
import type { AdskilteLop } from './AdskilteLop.ts'
import type { DetaljnivaParameter } from './DetaljnivaParameter.ts'
...
import type { Trafikantgruppe } from './Trafikantgruppe.ts'
import type { TypeVegSosi } from './TypeVegSosi.ts'
import type { VeglenkeTypeParameter } from './VeglenkeTypeParameter.ts'
import type { VegobjekterSide } from './VegobjekterSide.ts'
...
export type GetVegobjekterByTypeQueryParams = {
  ...
  riksvegrute?: string[]
  /**
   * @description Filtrer på vegforvalter. Kommaseparert liste. Se [/omrader/api/v4/vegforvaltere](https://nvdbapiles.atlas.vegvesen.no/swagger-ui/index.html?urls.primaryName=Omr%C3%A5der#/Omr%C3%A5der/getVegforvaltere) for mulige verdier.\n\nEksempel: `Møre og Romsdal fylkeskommune` eller som enumid `21774`
   * @type array | undefined
   */
  vegforvalter?: string[]
  /**
  ...
  /**
   * @description Filtrer vegobjekter med kartutsnitt i UTM 33. Formatet er `minX, minY, maxX, maxY`. Merk at vegobjektets bounding box benyttes for sammenligning, som kan medføre at vegobjekter som er utenfor kartutsnittet også returneres. For å unngå dette, kan du bruke `polygon` i stedet.\n\nEksempel: `265273, 7019372, 346553, 7061071`
   * @type string | undefined
   */
  kartutsnitt?: string
  /**
   * @description Filtrer vegobjekter med polygon i UTM 33.\n\nEksempel: `20000 6520000, 20500 6520000, 21000 6500000, 20000 6520000`
   * @type string | undefined
   */
  polygon?: string
  /**
...
export type GetVegobjekterByTypeQueryResponse = GetVegobjekterByType200

export type GetVegobjekterByTypeQuery = {
  Response: GetVegobjekterByType200
