...
export type GetVegobjektByTypeAndIdQueryParamsInkluder =
  | 'metadata'
  | 'egenskaper'
  | 'relasjoner'
  | 'lokasjon'
  ...
  | 'alle'
  | 'minimum'
export type GetVegobjektByTypeAndIdQueryParamsSrid =
  | '5972'
  | '5973'
  | '5975'
  | '4326'
  ...
  | 'UTM35'
  | 'WGS84'
export type GetVegobjektByTypeAndIdQueryParamsInkludergeometri =
  | 'ingen'
  | 'egenskaper'
  | 'lokasjon'
  | 'utledet'
export type GetVegobjektByTypeAndIdQueryParamsInkluderEgenskaper =
  | 'basis'
  | 'geometri'
  | 'alle'
export type GetVegobjektByTypeAndIdQueryParams = {
   ...
   */
  inkluder?: GetVegobjektByTypeAndIdQueryParamsInkluder[]
  /**
   ...
   */
  srid?: GetVegobjektByTypeAndIdQueryParamsSrid
  /**
   ...
   * @type string | undefined
   */
  inkludergeometri?: GetVegobjektByTypeAndIdQueryParamsInkludergeometri
  /**
   ...
   * @type string | undefined
   */
  inkluder_egenskaper?: GetVegobjektByTypeAndIdQueryParamsInkluderEgenskaper
  /**
