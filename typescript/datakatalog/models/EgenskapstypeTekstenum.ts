...
export function EgenskapstypeTekstenumFromJSON(json: any): EgenskapstypeTekstenum {
    return EgenskapstypeTekstenumFromJSONTyped(json, false);
}

export function EgenskapstypeTekstenumFromJSONTyped(json: any, ignoreDiscriminator: boolean): EgenskapstypeTekstenum {
    ...
    return {
        ...
        'tillatteVerdier': ((json['tillatte_verdier'] as Array<any>).map(EnumverdiTekstFromJSON)),
    };
}

export function EgenskapstypeTekstenumToJSON(value?: EgenskapstypeTekstenum | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'tillatte_verdier': ((value.tillatteVerdier as Array<any>).map(EnumverdiTekstToJSON)),
    };
}
