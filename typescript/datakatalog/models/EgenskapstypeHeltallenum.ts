...
export function EgenskapstypeHeltallenumFromJSON(json: any): EgenskapstypeHeltallenum {
    return EgenskapstypeHeltallenumFromJSONTyped(json, false);
}

export function EgenskapstypeHeltallenumFromJSONTyped(json: any, ignoreDiscriminator: boolean): EgenskapstypeHeltallenum {
    ...
    return {
        ...
        'tillatteVerdier': ((json['tillatte_verdier'] as Array<any>).map(EnumverdiHeltallFromJSON)),
    };
}

export function EgenskapstypeHeltallenumToJSON(value?: EgenskapstypeHeltallenum | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'tillatte_verdier': ((value.tillatteVerdier as Array<any>).map(EnumverdiHeltallToJSON)),
    };
}
