...
public class EgenskapstypeBinaer extends Egenskapstype {
  ...
  public EgenskapstypeBinaer objektlisteDato(@javax.annotation.Nullable LocalDate objektlisteDato) {
  ...
  public EgenskapstypeBinaer sluttDato(@javax.annotation.Nullable LocalDate sluttDato) {
  ...
  public EgenskapstypeBinaer lengdeavhengigVerdi(@javax.annotation.Nonnull Boolean lengdeavhengigVerdi) {
  ...
  public EgenskapstypeBinaer ajourholdSnu(@javax.annotation.Nonnull Boolean ajourholdSnu) {
  ...
  public EgenskapstypeBinaer mediatype(@javax.annotation.Nonnull MediatypeEnum mediatype) {
  ...
  @Override
  public EgenskapstypeBinaer id(@javax.annotation.Nonnull Integer id) {
    this.setId(id);
    return this;
  }

  @Override
  public EgenskapstypeBinaer navn(@javax.annotation.Nullable String navn) {
    this.setNavn(navn);
    return this;
  }

  @Override
  public EgenskapstypeBinaer egenskapstype(@javax.annotation.Nonnull EgenskapstypeEnum egenskapstype) {
    this.setEgenskapstype(egenskapstype);
    return this;
  }

  @Override
  public EgenskapstypeBinaer komplementærEgenskapstype(@javax.annotation.Nullable Integer komplementærEgenskapstype) {
    this.setKomplementærEgenskapstype(komplementærEgenskapstype);
    return this;
  }

  @Override
  public EgenskapstypeBinaer kortnavn(@javax.annotation.Nullable String kortnavn) {
    this.setKortnavn(kortnavn);
    return this;
  }

  @Override
  public EgenskapstypeBinaer beskrivelse(@javax.annotation.Nullable String beskrivelse) {
    this.setBeskrivelse(beskrivelse);
    return this;
  }

  @Override
  public EgenskapstypeBinaer sosinavn(@javax.annotation.Nullable String sosinavn) {
    this.setSosinavn(sosinavn);
    return this;
  }

  @Override
  public EgenskapstypeBinaer sosinvdbnavn(@javax.annotation.Nullable String sosinvdbnavn) {
    this.setSosinvdbnavn(sosinvdbnavn);
    return this;
  }

  @Override
  public EgenskapstypeBinaer sorteringsnummer(@javax.annotation.Nonnull Integer sorteringsnummer) {
    this.setSorteringsnummer(sorteringsnummer);
    return this;
  }

  @Override
  public EgenskapstypeBinaer avledet(@javax.annotation.Nonnull Boolean avledet) {
    this.setAvledet(avledet);
    return this;
  }

  @Override
  public EgenskapstypeBinaer obligatoriskVerdi(@javax.annotation.Nonnull Boolean obligatoriskVerdi) {
    this.setObligatoriskVerdi(obligatoriskVerdi);
    return this;
  }

  @Override
  public EgenskapstypeBinaer skrivebeskyttet(@javax.annotation.Nonnull Boolean skrivebeskyttet) {
    this.setSkrivebeskyttet(skrivebeskyttet);
    return this;
  }

  @Override
  public EgenskapstypeBinaer sensitivitet(@javax.annotation.Nonnull Integer sensitivitet) {
    this.setSensitivitet(sensitivitet);
    return this;
  }

  @Override
  public EgenskapstypeBinaer gruppesorteringsnummer(@javax.annotation.Nullable Integer gruppesorteringsnummer) {
    this.setGruppesorteringsnummer(gruppesorteringsnummer);
    return this;
  }

  @Override
  public EgenskapstypeBinaer veiledning(@javax.annotation.Nullable String veiledning) {
    this.setVeiledning(veiledning);
    return this;
  }

  @Override
  public EgenskapstypeBinaer grunnrissreferanse(@javax.annotation.Nullable String grunnrissreferanse) {
    this.setGrunnrissreferanse(grunnrissreferanse);
    return this;
  }

  @Override
  public EgenskapstypeBinaer høydereferanse(@javax.annotation.Nullable String høydereferanse) {
    this.setHøydereferanse(høydereferanse);
    return this;
  }

  @Override
  public EgenskapstypeBinaer høydereferanseTall(@javax.annotation.Nonnull Integer høydereferanseTall) {
    this.setHøydereferanseTall(høydereferanseTall);
    return this;
  }

  @Override
  public EgenskapstypeBinaer nøyaktighetskravGrunnriss(@javax.annotation.Nonnull Double nøyaktighetskravGrunnriss) {
    this.setNøyaktighetskravGrunnriss(nøyaktighetskravGrunnriss);
    return this;
  }

  @Override
  public EgenskapstypeBinaer nøyaktighetskravHøyde(@javax.annotation.Nonnull Double nøyaktighetskravHøyde) {
    this.setNøyaktighetskravHøyde(nøyaktighetskravHøyde);
    return this;
  }

  @Override
  public EgenskapstypeBinaer sosiReferanse(@javax.annotation.Nullable String sosiReferanse) {
    this.setSosiReferanse(sosiReferanse);
    return this;
  }

  @Override
  public EgenskapstypeBinaer referansegeometriTilstrekkelig(@javax.annotation.Nonnull Boolean referansegeometriTilstrekkelig) {
    this.setReferansegeometriTilstrekkelig(referansegeometriTilstrekkelig);
    return this;
  }

  @Override
  public EgenskapstypeBinaer viktighet(@javax.annotation.Nonnull Viktighet viktighet) {
    this.setViktighet(viktighet);
    return this;
  }

  @Override
  public EgenskapstypeBinaer kategori(@javax.annotation.Nonnull Integer kategori) {
