...
public class StedfestingEnkel extends Stedfesting {
  ...
  public StedfestingEnkel stedfestingstype(@javax.annotation.Nullable StedfestingstypeEnum stedfestingstype) {
  ...
  public StedfestingEnkel geometritype(@javax.annotation.Nullable GeometritypeEnum geometritype) {
  ...
  public StedfestingEnkel overlappOk(@javax.annotation.Nullable Boolean overlappOk) {
  ...
  public StedfestingEnkel kjørefeltRelevant(@javax.annotation.Nullable KjrefeltRelevantEnum kjørefeltRelevant) {
  ...
  public StedfestingEnkel sideposisjonRelevant(@javax.annotation.Nullable SideposisjonRelevantEnum sideposisjonRelevant) {
  ...
  public StedfestingEnkel innenforMor(@javax.annotation.Nullable Boolean innenforMor) {
  ...
  public StedfestingEnkel vegnettsajourholdSplitt(@javax.annotation.Nullable VegnettsajourholdSplittEnum vegnettsajourholdSplitt) {
  ...
  public StedfestingEnkel overlappsautomatikk(@javax.annotation.Nullable String overlappsautomatikk) {
  ...
  public StedfestingEnkel retningRelevant(@javax.annotation.Nullable Boolean retningRelevant) {
  ...
  @Override
  public StedfestingEnkel id(@javax.annotation.Nonnull Integer id) {
    this.setId(id);
    return this;
  }

  @Override
  public StedfestingEnkel navn(@javax.annotation.Nullable String navn) {
    this.setNavn(navn);
    return this;
  }

  @Override
  public StedfestingEnkel egenskapstype(@javax.annotation.Nonnull EgenskapstypeEnum egenskapstype) {
    this.setEgenskapstype(egenskapstype);
    return this;
  }

  @Override
  public StedfestingEnkel komplementærEgenskapstype(@javax.annotation.Nullable Integer komplementærEgenskapstype) {
    this.setKomplementærEgenskapstype(komplementærEgenskapstype);
    return this;
  }

  @Override
  public StedfestingEnkel kortnavn(@javax.annotation.Nullable String kortnavn) {
    this.setKortnavn(kortnavn);
    return this;
  }

  @Override
  public StedfestingEnkel beskrivelse(@javax.annotation.Nullable String beskrivelse) {
    this.setBeskrivelse(beskrivelse);
    return this;
  }

  @Override
  public StedfestingEnkel sosinavn(@javax.annotation.Nullable String sosinavn) {
    this.setSosinavn(sosinavn);
    return this;
  }

  @Override
  public StedfestingEnkel sosinvdbnavn(@javax.annotation.Nullable String sosinvdbnavn) {
    this.setSosinvdbnavn(sosinvdbnavn);
    return this;
  }

  @Override
  public StedfestingEnkel sorteringsnummer(@javax.annotation.Nonnull Integer sorteringsnummer) {
    this.setSorteringsnummer(sorteringsnummer);
    return this;
  }

  @Override
  public StedfestingEnkel avledet(@javax.annotation.Nonnull Boolean avledet) {
    this.setAvledet(avledet);
    return this;
  }

  @Override
  public StedfestingEnkel obligatoriskVerdi(@javax.annotation.Nonnull Boolean obligatoriskVerdi) {
    this.setObligatoriskVerdi(obligatoriskVerdi);
    return this;
  }

  @Override
  public StedfestingEnkel skrivebeskyttet(@javax.annotation.Nonnull Boolean skrivebeskyttet) {
    this.setSkrivebeskyttet(skrivebeskyttet);
    return this;
  }

  @Override
  public StedfestingEnkel sensitivitet(@javax.annotation.Nonnull Integer sensitivitet) {
    this.setSensitivitet(sensitivitet);
    return this;
  }

  @Override
  public StedfestingEnkel gruppesorteringsnummer(@javax.annotation.Nullable Integer gruppesorteringsnummer) {
    this.setGruppesorteringsnummer(gruppesorteringsnummer);
    return this;
  }

  @Override
  public StedfestingEnkel veiledning(@javax.annotation.Nullable String veiledning) {
    this.setVeiledning(veiledning);
    return this;
  }

  @Override
  public StedfestingEnkel grunnrissreferanse(@javax.annotation.Nullable String grunnrissreferanse) {
    this.setGrunnrissreferanse(grunnrissreferanse);
    return this;
  }

  @Override
  public StedfestingEnkel høydereferanse(@javax.annotation.Nullable String høydereferanse) {
    this.setHøydereferanse(høydereferanse);
    return this;
  }

  @Override
  public StedfestingEnkel høydereferanseTall(@javax.annotation.Nonnull Integer høydereferanseTall) {
    this.setHøydereferanseTall(høydereferanseTall);
    return this;
  }

  @Override
  public StedfestingEnkel nøyaktighetskravGrunnriss(@javax.annotation.Nonnull Double nøyaktighetskravGrunnriss) {
    this.setNøyaktighetskravGrunnriss(nøyaktighetskravGrunnriss);
    return this;
  }

  @Override
  public StedfestingEnkel nøyaktighetskravHøyde(@javax.annotation.Nonnull Double nøyaktighetskravHøyde) {
    this.setNøyaktighetskravHøyde(nøyaktighetskravHøyde);
    return this;
  }

  @Override
  public StedfestingEnkel sosiReferanse(@javax.annotation.Nullable String sosiReferanse) {
    this.setSosiReferanse(sosiReferanse);
    return this;
  }

  @Override
  public StedfestingEnkel referansegeometriTilstrekkelig(@javax.annotation.Nonnull Boolean referansegeometriTilstrekkelig) {
    this.setReferansegeometriTilstrekkelig(referansegeometriTilstrekkelig);
    return this;
  }

  @Override
  public StedfestingEnkel viktighet(@javax.annotation.Nonnull Viktighet viktighet) {
    this.setViktighet(viktighet);
    return this;
  }

  @Override
  public StedfestingEnkel kategori(@javax.annotation.Nonnull Integer kategori) {
