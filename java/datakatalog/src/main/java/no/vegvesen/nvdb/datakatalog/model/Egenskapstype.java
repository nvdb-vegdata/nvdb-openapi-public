...
public class Egenskapstype {
  ...
  public Egenskapstype id(@javax.annotation.Nonnull Integer id) {
  ...
  public Egenskapstype navn(@javax.annotation.Nullable String navn) {
  ...
  public Egenskapstype egenskapstype(@javax.annotation.Nonnull EgenskapstypeEnum egenskapstype) {
  ...
  @JsonProperty(JSON_PROPERTY_EGENSKAPSTYPE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setEgenskapstype(@javax.annotation.Nonnull EgenskapstypeEnum egenskapstype) {
    this.egenskapstype = egenskapstype;
  }

  public Egenskapstype komplementærEgenskapstype(@javax.annotation.Nullable Integer komplementærEgenskapstype) {
  ...
  @JsonProperty(JSON_PROPERTY_KOMPLEMENTæR_EGENSKAPSTYPE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setKomplementærEgenskapstype(@javax.annotation.Nullable Integer komplementærEgenskapstype) {
    this.komplementærEgenskapstype = komplementærEgenskapstype;
  }

  public Egenskapstype kortnavn(@javax.annotation.Nullable String kortnavn) {
  ...
  public Egenskapstype beskrivelse(@javax.annotation.Nullable String beskrivelse) {
  ...
  public Egenskapstype sosinavn(@javax.annotation.Nullable String sosinavn) {
  ...
  public Egenskapstype sosinvdbnavn(@javax.annotation.Nullable String sosinvdbnavn) {
  ...
  public Egenskapstype sorteringsnummer(@javax.annotation.Nonnull Integer sorteringsnummer) {
  ...
  public Egenskapstype avledet(@javax.annotation.Nonnull Boolean avledet) {
  ...
  public Egenskapstype obligatoriskVerdi(@javax.annotation.Nonnull Boolean obligatoriskVerdi) {
  ...
  @JsonProperty(JSON_PROPERTY_OBLIGATORISK_VERDI)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setObligatoriskVerdi(@javax.annotation.Nonnull Boolean obligatoriskVerdi) {
    this.obligatoriskVerdi = obligatoriskVerdi;
  }

  public Egenskapstype skrivebeskyttet(@javax.annotation.Nonnull Boolean skrivebeskyttet) {
  ...
  @JsonProperty(JSON_PROPERTY_SKRIVEBESKYTTET)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setSkrivebeskyttet(@javax.annotation.Nonnull Boolean skrivebeskyttet) {
    this.skrivebeskyttet = skrivebeskyttet;
  }

  public Egenskapstype sensitivitet(@javax.annotation.Nonnull Integer sensitivitet) {
  ...
  @JsonProperty(JSON_PROPERTY_SENSITIVITET)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setSensitivitet(@javax.annotation.Nonnull Integer sensitivitet) {
    this.sensitivitet = sensitivitet;
  }

  public Egenskapstype gruppesorteringsnummer(@javax.annotation.Nullable Integer gruppesorteringsnummer) {
  ...
  @JsonProperty(JSON_PROPERTY_GRUPPESORTERINGSNUMMER)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setGruppesorteringsnummer(@javax.annotation.Nullable Integer gruppesorteringsnummer) {
    this.gruppesorteringsnummer = gruppesorteringsnummer;
  }

  public Egenskapstype veiledning(@javax.annotation.Nullable String veiledning) {
  ...
  @JsonProperty(JSON_PROPERTY_VEILEDNING)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setVeiledning(@javax.annotation.Nullable String veiledning) {
    this.veiledning = veiledning;
  }

  public Egenskapstype grunnrissreferanse(@javax.annotation.Nullable String grunnrissreferanse) {
  ...
  @JsonProperty(JSON_PROPERTY_GRUNNRISSREFERANSE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setGrunnrissreferanse(@javax.annotation.Nullable String grunnrissreferanse) {
    this.grunnrissreferanse = grunnrissreferanse;
  }

  public Egenskapstype høydereferanse(@javax.annotation.Nullable String høydereferanse) {
  ...
  @JsonProperty(JSON_PROPERTY_HøYDEREFERANSE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setHøydereferanse(@javax.annotation.Nullable String høydereferanse) {
    this.høydereferanse = høydereferanse;
  }

  public Egenskapstype høydereferanseTall(@javax.annotation.Nonnull Integer høydereferanseTall) {
  ...
  @JsonProperty(JSON_PROPERTY_HøYDEREFERANSE_TALL)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setHøydereferanseTall(@javax.annotation.Nonnull Integer høydereferanseTall) {
    this.høydereferanseTall = høydereferanseTall;
  }

  public Egenskapstype nøyaktighetskravGrunnriss(@javax.annotation.Nonnull Double nøyaktighetskravGrunnriss) {
  ...
  @JsonProperty(JSON_PROPERTY_NøYAKTIGHETSKRAV_GRUNNRISS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setNøyaktighetskravGrunnriss(@javax.annotation.Nonnull Double nøyaktighetskravGrunnriss) {
    this.nøyaktighetskravGrunnriss = nøyaktighetskravGrunnriss;
  }

  public Egenskapstype nøyaktighetskravHøyde(@javax.annotation.Nonnull Double nøyaktighetskravHøyde) {
  ...
  @JsonProperty(JSON_PROPERTY_NøYAKTIGHETSKRAV_HøYDE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setNøyaktighetskravHøyde(@javax.annotation.Nonnull Double nøyaktighetskravHøyde) {
    this.nøyaktighetskravHøyde = nøyaktighetskravHøyde;
  }

  public Egenskapstype sosiReferanse(@javax.annotation.Nullable String sosiReferanse) {
  ...
  @JsonProperty(JSON_PROPERTY_SOSI_REFERANSE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSosiReferanse(@javax.annotation.Nullable String sosiReferanse) {
    this.sosiReferanse = sosiReferanse;
  }

  public Egenskapstype referansegeometriTilstrekkelig(@javax.annotation.Nonnull Boolean referansegeometriTilstrekkelig) {
  ...
  @JsonProperty(JSON_PROPERTY_REFERANSEGEOMETRI_TILSTREKKELIG)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setReferansegeometriTilstrekkelig(@javax.annotation.Nonnull Boolean referansegeometriTilstrekkelig) {
    this.referansegeometriTilstrekkelig = referansegeometriTilstrekkelig;
  }

  public Egenskapstype viktighet(@javax.annotation.Nonnull Viktighet viktighet) {
  ...
  @JsonProperty(JSON_PROPERTY_VIKTIGHET)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setViktighet(@javax.annotation.Nonnull Viktighet viktighet) {
    this.viktighet = viktighet;
  }

  public Egenskapstype kategori(@javax.annotation.Nonnull Integer kategori) {
  ...
  @JsonProperty(JSON_PROPERTY_KATEGORI)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setKategori(@javax.annotation.Nonnull Integer kategori) {
    this.kategori = kategori;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, navn, egenskapstype, komplementærEgenskapstype, kortnavn, beskrivelse, sosinavn, sosinvdbnavn, sorteringsnummer, avledet, obligatoriskVerdi, skrivebeskyttet, sensitivitet, gruppesorteringsnummer, veiledning, grunnrissreferanse, høydereferanse, høydereferanseTall, nøyaktighetskravGrunnriss, nøyaktighetskravHøyde, sosiReferanse, referansegeometriTilstrekkelig, viktighet, kategori);
  }
