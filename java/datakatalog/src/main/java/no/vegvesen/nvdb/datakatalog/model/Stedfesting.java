...
public class Stedfesting {
  ...
  public Stedfesting id(@javax.annotation.Nonnull Integer id) {
  ...
  public Stedfesting navn(@javax.annotation.Nullable String navn) {
  ...
  public Stedfesting egenskapstype(@javax.annotation.Nonnull EgenskapstypeEnum egenskapstype) {
  ...
  public Stedfesting komplementærEgenskapstype(@javax.annotation.Nullable Integer komplementærEgenskapstype) {
  ...
  public Stedfesting kortnavn(@javax.annotation.Nullable String kortnavn) {
  ...
  public Stedfesting beskrivelse(@javax.annotation.Nullable String beskrivelse) {
  ...
  public Stedfesting sosinavn(@javax.annotation.Nullable String sosinavn) {
  ...
  public Stedfesting sosinvdbnavn(@javax.annotation.Nullable String sosinvdbnavn) {
  ...
  public Stedfesting sorteringsnummer(@javax.annotation.Nonnull Integer sorteringsnummer) {
  ...
  public Stedfesting avledet(@javax.annotation.Nonnull Boolean avledet) {
  ...
  public Stedfesting obligatoriskVerdi(@javax.annotation.Nonnull Boolean obligatoriskVerdi) {
  ...
  public Stedfesting skrivebeskyttet(@javax.annotation.Nonnull Boolean skrivebeskyttet) {
  ...
  public Stedfesting sensitivitet(@javax.annotation.Nonnull Integer sensitivitet) {
  ...
  public Stedfesting gruppesorteringsnummer(@javax.annotation.Nullable Integer gruppesorteringsnummer) {
  ...
  public Stedfesting veiledning(@javax.annotation.Nullable String veiledning) {
  ...
  public Stedfesting grunnrissreferanse(@javax.annotation.Nullable String grunnrissreferanse) {
  ...
  public Stedfesting høydereferanse(@javax.annotation.Nullable String høydereferanse) {
  ...
  public Stedfesting høydereferanseTall(@javax.annotation.Nonnull Integer høydereferanseTall) {
  ...
  public Stedfesting nøyaktighetskravGrunnriss(@javax.annotation.Nonnull Double nøyaktighetskravGrunnriss) {
  ...
  public Stedfesting nøyaktighetskravHøyde(@javax.annotation.Nonnull Double nøyaktighetskravHøyde) {
  ...
  public Stedfesting sosiReferanse(@javax.annotation.Nullable String sosiReferanse) {
  ...
  public Stedfesting referansegeometriTilstrekkelig(@javax.annotation.Nonnull Boolean referansegeometriTilstrekkelig) {
  ...
  public Stedfesting viktighet(@javax.annotation.Nonnull Viktighet viktighet) {
  ...
  public Stedfesting kategori(@javax.annotation.Nonnull Integer kategori) {
