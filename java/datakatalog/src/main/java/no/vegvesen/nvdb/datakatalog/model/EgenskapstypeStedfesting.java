...
public class EgenskapstypeStedfesting extends Egenskapstype {
  ...
  public EgenskapstypeStedfesting stedfestingstype(@javax.annotation.Nullable StedfestingstypeEnum stedfestingstype) {
  ...
  @JsonProperty(JSON_PROPERTY_STEDFESTINGSTYPE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setStedfestingstype(@javax.annotation.Nullable StedfestingstypeEnum stedfestingstype) {
    this.stedfestingstype = stedfestingstype;
  }

  public EgenskapstypeStedfesting geometritype(@javax.annotation.Nullable GeometritypeEnum geometritype) {
  ...
  @JsonProperty(JSON_PROPERTY_GEOMETRITYPE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setGeometritype(@javax.annotation.Nullable GeometritypeEnum geometritype) {
    this.geometritype = geometritype;
  }

  public EgenskapstypeStedfesting overlappOk(@javax.annotation.Nullable Boolean overlappOk) {
  ...
  @JsonProperty(JSON_PROPERTY_OVERLAPP_OK)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setOverlappOk(@javax.annotation.Nullable Boolean overlappOk) {
    this.overlappOk = overlappOk;
  }

  public EgenskapstypeStedfesting kjørefeltRelevant(@javax.annotation.Nullable KjrefeltRelevantEnum kjørefeltRelevant) {
  ...
  @JsonProperty(JSON_PROPERTY_KJøREFELT_RELEVANT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setKjørefeltRelevant(@javax.annotation.Nullable KjrefeltRelevantEnum kjørefeltRelevant) {
    this.kjørefeltRelevant = kjørefeltRelevant;
  }

  public EgenskapstypeStedfesting sideposisjonRelevant(@javax.annotation.Nullable SideposisjonRelevantEnum sideposisjonRelevant) {
  ...
  @JsonProperty(JSON_PROPERTY_SIDEPOSISJON_RELEVANT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSideposisjonRelevant(@javax.annotation.Nullable SideposisjonRelevantEnum sideposisjonRelevant) {
    this.sideposisjonRelevant = sideposisjonRelevant;
  }

  public EgenskapstypeStedfesting innenforMor(@javax.annotation.Nullable Boolean innenforMor) {
  ...
  @JsonProperty(JSON_PROPERTY_INNENFOR_MOR)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setInnenforMor(@javax.annotation.Nullable Boolean innenforMor) {
    this.innenforMor = innenforMor;
  }

  public EgenskapstypeStedfesting vegnettsajourholdSplitt(@javax.annotation.Nullable VegnettsajourholdSplittEnum vegnettsajourholdSplitt) {
  ...
  @JsonProperty(JSON_PROPERTY_VEGNETTSAJOURHOLD_SPLITT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setVegnettsajourholdSplitt(@javax.annotation.Nullable VegnettsajourholdSplittEnum vegnettsajourholdSplitt) {
    this.vegnettsajourholdSplitt = vegnettsajourholdSplitt;
  }

  public EgenskapstypeStedfesting overlappsautomatikk(@javax.annotation.Nullable String overlappsautomatikk) {
  ...
  @JsonProperty(JSON_PROPERTY_OVERLAPPSAUTOMATIKK)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setOverlappsautomatikk(@javax.annotation.Nullable String overlappsautomatikk) {
    this.overlappsautomatikk = overlappsautomatikk;
  }

  public EgenskapstypeStedfesting retningRelevant(@javax.annotation.Nullable Boolean retningRelevant) {
  ...
  @JsonProperty(JSON_PROPERTY_RETNING_RELEVANT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRetningRelevant(@javax.annotation.Nullable Boolean retningRelevant) {
    this.retningRelevant = retningRelevant;
  }


  @Override
  public EgenskapstypeStedfesting id(@javax.annotation.Nonnull Integer id) {
    this.setId(id);
    return this;
  }

  @Override
  public EgenskapstypeStedfesting navn(@javax.annotation.Nullable String navn) {
    this.setNavn(navn);
    return this;
  }

  @Override
  public EgenskapstypeStedfesting egenskapstype(@javax.annotation.Nonnull EgenskapstypeEnum egenskapstype) {
  ...
  @Override
  public EgenskapstypeStedfesting skrivebeskyttet(@javax.annotation.Nonnull Boolean skrivebeskyttet) {
    this.setSkrivebeskyttet(skrivebeskyttet);
    return this;
  }

  @Override
  public EgenskapstypeStedfesting sensitivitet(@javax.annotation.Nonnull Integer sensitivitet) {
    this.setSensitivitet(sensitivitet);
    return this;
  }

  @Override
  public EgenskapstypeStedfesting gruppesorteringsnummer(@javax.annotation.Nullable Integer gruppesorteringsnummer) {
    this.setGruppesorteringsnummer(gruppesorteringsnummer);
    return this;
  }

  @Override
  public EgenskapstypeStedfesting veiledning(@javax.annotation.Nullable String veiledning) {
    this.setVeiledning(veiledning);
    return this;
  }

  @Override
  public EgenskapstypeStedfesting grunnrissreferanse(@javax.annotation.Nullable String grunnrissreferanse) {
    this.setGrunnrissreferanse(grunnrissreferanse);
    return this;
  }

  @Override
  public EgenskapstypeStedfesting høydereferanse(@javax.annotation.Nullable String høydereferanse) {
    this.setHøydereferanse(høydereferanse);
    return this;
  }

  @Override
  public EgenskapstypeStedfesting høydereferanseTall(@javax.annotation.Nonnull Integer høydereferanseTall) {
    this.setHøydereferanseTall(høydereferanseTall);
    return this;
  }

  @Override
  public EgenskapstypeStedfesting nøyaktighetskravGrunnriss(@javax.annotation.Nonnull Double nøyaktighetskravGrunnriss) {
    this.setNøyaktighetskravGrunnriss(nøyaktighetskravGrunnriss);
    return this;
  }

  @Override
  public EgenskapstypeStedfesting nøyaktighetskravHøyde(@javax.annotation.Nonnull Double nøyaktighetskravHøyde) {
    this.setNøyaktighetskravHøyde(nøyaktighetskravHøyde);
    return this;
  }

  @Override
  public EgenskapstypeStedfesting sosiReferanse(@javax.annotation.Nullable String sosiReferanse) {
    this.setSosiReferanse(sosiReferanse);
    return this;
  }

  @Override
  public EgenskapstypeStedfesting referansegeometriTilstrekkelig(@javax.annotation.Nonnull Boolean referansegeometriTilstrekkelig) {
    this.setReferansegeometriTilstrekkelig(referansegeometriTilstrekkelig);
    return this;
  }

  @Override
  public EgenskapstypeStedfesting viktighet(@javax.annotation.Nonnull Viktighet viktighet) {
