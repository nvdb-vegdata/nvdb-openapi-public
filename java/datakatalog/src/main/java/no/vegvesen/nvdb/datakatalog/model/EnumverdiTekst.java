...
public class EnumverdiTekst {
  ...
  public EnumverdiTekst id(@javax.annotation.Nonnull Integer id) {
  ...
  public EnumverdiTekst kortnavn(@javax.annotation.Nullable String kortnavn) {
  ...
  public EnumverdiTekst kortnavnlengde(@javax.annotation.Nullable Integer kortnavnlengde) {
  ...
  public EnumverdiTekst kortnavnBrukbar(@javax.annotation.Nonnull Boolean kortnavnBrukbar) {
  ...
  public EnumverdiTekst beskrivelse(@javax.annotation.Nullable String beskrivelse) {
  ...
  public EnumverdiTekst sorteringsnummer(@javax.annotation.Nonnull Integer sorteringsnummer) {
  ...
  public EnumverdiTekst objektlisteDato(@javax.annotation.Nullable LocalDate objektlisteDato) {
  ...
  public EnumverdiTekst sluttdato(@javax.annotation.Nullable LocalDate sluttdato) {
  ...
  public EnumverdiTekst standardverdi(@javax.annotation.Nonnull Boolean standardverdi) {
  ...
  public EnumverdiTekst komplementærEnumverdi(@javax.annotation.Nullable Integer komplementærEnumverdi) {
  ...
  public EnumverdiTekst verdi(@javax.annotation.Nullable String verdi) {
  ...
  @JsonProperty(JSON_PROPERTY_VERDI)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setVerdi(@javax.annotation.Nullable String verdi) {
    this.verdi = verdi;
  }

  public EnumverdiTekst type(@javax.annotation.Nonnull String type) {
