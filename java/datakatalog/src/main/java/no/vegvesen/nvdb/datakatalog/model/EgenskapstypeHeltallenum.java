...
public class EgenskapstypeHeltallenum extends Egenskapstype {
  ...
  public EgenskapstypeHeltallenum objektlisteDato(@javax.annotation.Nullable LocalDate objektlisteDato) {
  ...
  public EgenskapstypeHeltallenum sluttDato(@javax.annotation.Nullable LocalDate sluttDato) {
  ...
  public EgenskapstypeHeltallenum lengdeavhengigVerdi(@javax.annotation.Nonnull Boolean lengdeavhengigVerdi) {
  ...
  public EgenskapstypeHeltallenum ajourholdSnu(@javax.annotation.Nonnull Boolean ajourholdSnu) {
  ...
  public EgenskapstypeHeltallenum standardverdi(@javax.annotation.Nullable Integer standardverdi) {
  ...
  public EgenskapstypeHeltallenum minAnbefalt(@javax.annotation.Nullable Integer minAnbefalt) {
  ...
  public EgenskapstypeHeltallenum maksAnbefalt(@javax.annotation.Nullable Integer maksAnbefalt) {
  ...
  public EgenskapstypeHeltallenum min(@javax.annotation.Nullable Integer min) {
  ...
  public EgenskapstypeHeltallenum maks(@javax.annotation.Nullable Integer maks) {
  ...
  public EgenskapstypeHeltallenum feltlengde(@javax.annotation.Nullable Integer feltlengde) {
  ...
  public EgenskapstypeHeltallenum fortegnsendringSnu(@javax.annotation.Nonnull Boolean fortegnsendringSnu) {
  ...
  public EgenskapstypeHeltallenum enhet(@javax.annotation.Nullable Enhet enhet) {
  ...
  public EgenskapstypeHeltallenum tillatteVerdier(@javax.annotation.Nonnull List<EnumverdiHeltall> tillatteVerdier) {
  ...
  @JsonProperty(JSON_PROPERTY_TILLATTE_VERDIER)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setTillatteVerdier(@javax.annotation.Nonnull List<EnumverdiHeltall> tillatteVerdier) {
    this.tillatteVerdier = tillatteVerdier;
  }


  @Override
  public EgenskapstypeHeltallenum id(@javax.annotation.Nonnull Integer id) {
    this.setId(id);
    return this;
  }

  @Override
  public EgenskapstypeHeltallenum navn(@javax.annotation.Nullable String navn) {
    this.setNavn(navn);
    return this;
  }

  @Override
  public EgenskapstypeHeltallenum egenskapstype(@javax.annotation.Nonnull EgenskapstypeEnum egenskapstype) {
    this.setEgenskapstype(egenskapstype);
    return this;
  }

  @Override
  public EgenskapstypeHeltallenum komplementærEgenskapstype(@javax.annotation.Nullable Integer komplementærEgenskapstype) {
    this.setKomplementærEgenskapstype(komplementærEgenskapstype);
    return this;
  }

  @Override
  public EgenskapstypeHeltallenum kortnavn(@javax.annotation.Nullable String kortnavn) {
    this.setKortnavn(kortnavn);
    return this;
  }

  @Override
  public EgenskapstypeHeltallenum beskrivelse(@javax.annotation.Nullable String beskrivelse) {
    this.setBeskrivelse(beskrivelse);
    return this;
  }

  @Override
  public EgenskapstypeHeltallenum sosinavn(@javax.annotation.Nullable String sosinavn) {
    this.setSosinavn(sosinavn);
    return this;
  }

  @Override
  public EgenskapstypeHeltallenum sosinvdbnavn(@javax.annotation.Nullable String sosinvdbnavn) {
    this.setSosinvdbnavn(sosinvdbnavn);
    return this;
  }

  @Override
  public EgenskapstypeHeltallenum sorteringsnummer(@javax.annotation.Nonnull Integer sorteringsnummer) {
    this.setSorteringsnummer(sorteringsnummer);
    return this;
  }

  @Override
  public EgenskapstypeHeltallenum avledet(@javax.annotation.Nonnull Boolean avledet) {
    this.setAvledet(avledet);
    return this;
  }

  @Override
  public EgenskapstypeHeltallenum obligatoriskVerdi(@javax.annotation.Nonnull Boolean obligatoriskVerdi) {
    this.setObligatoriskVerdi(obligatoriskVerdi);
    return this;
  }

  @Override
  public EgenskapstypeHeltallenum skrivebeskyttet(@javax.annotation.Nonnull Boolean skrivebeskyttet) {
    this.setSkrivebeskyttet(skrivebeskyttet);
    return this;
  }

  @Override
  public EgenskapstypeHeltallenum sensitivitet(@javax.annotation.Nonnull Integer sensitivitet) {
    this.setSensitivitet(sensitivitet);
    return this;
  }

  @Override
  public EgenskapstypeHeltallenum gruppesorteringsnummer(@javax.annotation.Nullable Integer gruppesorteringsnummer) {
    this.setGruppesorteringsnummer(gruppesorteringsnummer);
    return this;
  }

  @Override
  public EgenskapstypeHeltallenum veiledning(@javax.annotation.Nullable String veiledning) {
    this.setVeiledning(veiledning);
    return this;
  }

  @Override
  public EgenskapstypeHeltallenum grunnrissreferanse(@javax.annotation.Nullable String grunnrissreferanse) {
    this.setGrunnrissreferanse(grunnrissreferanse);
    return this;
  }

  @Override
  public EgenskapstypeHeltallenum høydereferanse(@javax.annotation.Nullable String høydereferanse) {
    this.setHøydereferanse(høydereferanse);
    return this;
  }

  @Override
  public EgenskapstypeHeltallenum høydereferanseTall(@javax.annotation.Nonnull Integer høydereferanseTall) {
    this.setHøydereferanseTall(høydereferanseTall);
    return this;
  }

  @Override
  public EgenskapstypeHeltallenum nøyaktighetskravGrunnriss(@javax.annotation.Nonnull Double nøyaktighetskravGrunnriss) {
    this.setNøyaktighetskravGrunnriss(nøyaktighetskravGrunnriss);
    return this;
  }

  @Override
  public EgenskapstypeHeltallenum nøyaktighetskravHøyde(@javax.annotation.Nonnull Double nøyaktighetskravHøyde) {
    this.setNøyaktighetskravHøyde(nøyaktighetskravHøyde);
    return this;
  }

  @Override
  public EgenskapstypeHeltallenum sosiReferanse(@javax.annotation.Nullable String sosiReferanse) {
    this.setSosiReferanse(sosiReferanse);
    return this;
  }

  @Override
  public EgenskapstypeHeltallenum referansegeometriTilstrekkelig(@javax.annotation.Nonnull Boolean referansegeometriTilstrekkelig) {
    this.setReferansegeometriTilstrekkelig(referansegeometriTilstrekkelig);
    return this;
  }

  @Override
  public EgenskapstypeHeltallenum viktighet(@javax.annotation.Nonnull Viktighet viktighet) {
    this.setViktighet(viktighet);
    return this;
  }

  @Override
  public EgenskapstypeHeltallenum kategori(@javax.annotation.Nonnull Integer kategori) {
