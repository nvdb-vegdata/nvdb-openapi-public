...
public class EnumverdiHeltall {
  ...
  public EnumverdiHeltall id(@jakarta.annotation.Nonnull Integer id) {
  ...
  public EnumverdiHeltall kortnavn(@jakarta.annotation.Nullable String kortnavn) {
  ...
  public EnumverdiHeltall kortnavnlengde(@jakarta.annotation.Nullable Integer kortnavnlengde) {
  ...
  public EnumverdiHeltall kortnavnBrukbar(@jakarta.annotation.Nonnull Boolean kortnavnBrukbar) {
  ...
  public EnumverdiHeltall beskrivelse(@jakarta.annotation.Nullable String beskrivelse) {
  ...
  public EnumverdiHeltall sorteringsnummer(@jakarta.annotation.Nonnull Integer sorteringsnummer) {
  ...
  public EnumverdiHeltall objektlisteDato(@jakarta.annotation.Nullable LocalDate objektlisteDato) {
  ...
  public EnumverdiHeltall sluttdato(@jakarta.annotation.Nullable LocalDate sluttdato) {
  ...
  public EnumverdiHeltall standardverdi(@jakarta.annotation.Nonnull Boolean standardverdi) {
  ...
  public EnumverdiHeltall komplementærEnumverdi(@jakarta.annotation.Nullable Integer komplementærEnumverdi) {
  ...
  public EnumverdiHeltall verdi(@jakarta.annotation.Nullable Integer verdi) {
  ...
  public EnumverdiHeltall type(@jakarta.annotation.Nonnull String type) {
