...
import no.vegvesen.vt.nvdb.datakatalog.infrastructure.auth.Authentication;
import no.vegvesen.vt.nvdb.datakatalog.infrastructure.auth.HttpBasicAuth;
import no.vegvesen.vt.nvdb.datakatalog.infrastructure.auth.HttpBearerAuth;
import no.vegvesen.vt.nvdb.datakatalog.infrastructure.auth.ApiKeyAuth;
...
public class ApiClient extends JavaTimeFormatter {
    ...
    protected String basePath = "https://nvdbapiles.atlas.vegvesen.no/datakatalog";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
        new ServerConfiguration(
            "https://nvdbapiles.atlas.vegvesen.no/datakatalog",
            "Default Server URL",
