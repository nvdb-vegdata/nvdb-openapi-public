 ...
 */
@JsonPropertyOrder({
  VeglenkesekvensFjernet.JSON_PROPERTY_ID,
  VeglenkesekvensFjernet.JSON_PROPERTY_TIDSPUNKT
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class VeglenkesekvensFjernet {
  ...
  public VeglenkesekvensFjernet() {
  }

  public VeglenkesekvensFjernet id(@jakarta.annotation.Nonnull Long id) {
  ...
  public VeglenkesekvensFjernet tidspunkt(@jakarta.annotation.Nonnull OffsetDateTime tidspunkt) {
  ...
  public boolean equals(Object o) {
    ...
    VeglenkesekvensFjernet veglenkesekvensFjernet = (VeglenkesekvensFjernet) o;
    return Objects.equals(this.id, veglenkesekvensFjernet.id) &&
        Objects.equals(this.tidspunkt, veglenkesekvensFjernet.tidspunkt);
  }
  ...
  public String toString() {
    ...
    sb.append("class VeglenkesekvensFjernet {\n");
