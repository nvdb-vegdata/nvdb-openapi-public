 ...
 */
@JsonPropertyOrder({
  PosisjonGeometri.JSON_PROPERTY_WKT,
  PosisjonGeometri.JSON_PROPERTY_SRID
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class PosisjonGeometri {
  ...
  public PosisjonGeometri() {
  }

  public PosisjonGeometri wkt(@jakarta.annotation.Nonnull String wkt) {
  ...
  public PosisjonGeometri srid(@jakarta.annotation.Nonnull Integer srid) {
  ...
  public boolean equals(Object o) {
    ...
    PosisjonGeometri posisjonGeometri = (PosisjonGeometri) o;
    return Objects.equals(this.wkt, posisjonGeometri.wkt) &&
        Objects.equals(this.srid, posisjonGeometri.srid);
  }
  ...
  public String toString() {
    ...
    sb.append("class PosisjonGeometri {\n");
