...
public class VeglenkesegmenterSide {
  ...
  private List<Veglenkesegment> objekter = new ArrayList<>();
  ...
  public VeglenkesegmenterSide objekter(@jakarta.annotation.Nonnull List<Veglenkesegment> objekter) {
    
    this.objekter = objekter;
    return this;
  }

  public VeglenkesegmenterSide addObjekterItem(Veglenkesegment objekterItem) {
  ...
  public List<Veglenkesegment> getObjekter() {
    return objekter;
  }
  ...
  @JsonProperty(JSON_PROPERTY_OBJEKTER)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setObjekter(@jakarta.annotation.Nonnull List<Veglenkesegment> objekter) {
    this.objekter = objekter;
  }

  public VeglenkesegmenterSide metadata(@jakarta.annotation.Nonnull SideMetadata metadata) {
  ...
  public boolean equals(Object o) {
    ...
    VeglenkesegmenterSide veglenkesegmenterSide = (VeglenkesegmenterSide) o;
    return Objects.equals(this.objekter, veglenkesegmenterSide.objekter) &&
        Objects.equals(this.metadata, veglenkesegmenterSide.metadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class VeglenkesegmenterSide {\n");
