 ...
 */
@JsonPropertyOrder({
  VeglenkesekvenserSide.JSON_PROPERTY_OBJEKTER,
...
public class VeglenkesekvenserSide {
  ...
  private List<Veglenkesekvens> objekter = new ArrayList<>();
  ...
  public VeglenkesekvenserSide objekter(@jakarta.annotation.Nonnull List<Veglenkesekvens> objekter) {
    
    this.objekter = objekter;
    return this;
  }

  public VeglenkesekvenserSide addObjekterItem(Veglenkesekvens objekterItem) {
  ...
  public List<Veglenkesekvens> getObjekter() {
    return objekter;
  }
  ...
  @JsonProperty(JSON_PROPERTY_OBJEKTER)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setObjekter(@jakarta.annotation.Nonnull List<Veglenkesekvens> objekter) {
    this.objekter = objekter;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.objekter, veglenkesekvenserSide.objekter) &&
