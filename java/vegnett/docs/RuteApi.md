...
public class Example {
    public static void main(String[] args) {
        ...
        Integer omkrets = 56; // Integer | Konvolutt lagt rundt start- og slutt-punkt for å beregne rute.  Standardverdi: `200`. Maksverdi: `1500`. Må være større enn 0.
...
| **omkrets**               | **Integer**                          | Konvolutt lagt rundt start- og slutt-punkt for å beregne rute. Standardverdi: &#x60;200&#x60;. Maksverdi: &#x60;1500&#x60;. Må være større enn 0.                                                                                                                                                                                                                                                                                                                                                                                                                                      | [optional]                                                            |
