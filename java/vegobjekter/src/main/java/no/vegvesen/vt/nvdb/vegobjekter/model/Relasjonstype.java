 ...
 */
public enum Relasjonstype {
  
  VEGOBJEKTER("vegobjekter"),
  
  VEGOBJEKT_IDER("vegobjektIder");

  private String value;

  Relasjonstype(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static Relasjonstype fromValue(String value) {
    for (Relasjonstype b : Relasjonstype.values()) {
