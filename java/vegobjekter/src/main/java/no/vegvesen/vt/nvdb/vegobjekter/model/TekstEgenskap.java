 ...
 */
@JsonPropertyOrder({
  TekstEgenskap.JSON_PROPERTY_VERDI
})
...
public class TekstEgenskap extends Egenskap {
  public static final String JSON_PROPERTY_VERDI = "verdi";
  @jakarta.annotation.Nullable
  private String verdi;

  public TekstEgenskap() {

  }

  public TekstEgenskap verdi(@jakarta.annotation.Nullable String verdi) {
  ...
  @Override
  public TekstEgenskap id(@jakarta.annotation.Nonnull Integer id) {
    this.setId(id);
    return this;
  }

  @Override
  public TekstEgenskap navn(@jakarta.annotation.Nonnull String navn) {
    this.setNavn(navn);
    return this;
  }

  @Override
  public TekstEgenskap egenskapstype(@jakarta.annotation.Nonnull Egenskapstype egenskapstype) {
  ...
  public boolean equals(Object o) {
    ...
    TekstEgenskap tekstEgenskap = (TekstEgenskap) o;
    return Objects.equals(this.verdi, tekstEgenskap.verdi) &&
        super.equals(o);
  }
