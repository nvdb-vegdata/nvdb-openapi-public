 ...
 */
@JsonPropertyOrder({
  RelasjonMedIder.JSON_PROPERTY_VEGOBJEKTER
})
...
public class RelasjonMedIder extends Relasjon {
  public static final String JSON_PROPERTY_VEGOBJEKTER = "vegobjekter";
  @jakarta.annotation.Nonnull
  private List<Long> vegobjekter = new ArrayList<>();

  public RelasjonMedIder() {

  }

  public RelasjonMedIder vegobjekter(@jakarta.annotation.Nonnull List<Long> vegobjekter) {
    
    this.vegobjekter = vegobjekter;
    return this;
  }

  public RelasjonMedIder addVegobjekterItem(Long vegobjekterItem) {
   ...
   */
  @jakarta.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_VEGOBJEKTER, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public List<Long> getVegobjekter() {
    return vegobjekter;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_VEGOBJEKTER, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setVegobjekter(@jakarta.annotation.Nonnull List<Long> vegobjekter) {
    this.vegobjekter = vegobjekter;
  }


  @Override
  public RelasjonMedIder id(@jakarta.annotation.Nonnull Integer id) {
    this.setId(id);
    return this;
  }

  @Override
  public RelasjonMedIder type(@jakarta.annotation.Nonnull VegobjektType type) {
    this.setType(type);
    return this;
  }
  ...
  @Override
  public RelasjonMedIder listeid(@jakarta.annotation.Nullable Integer listeid) {
  ...
  public boolean equals(Object o) {
    ...
    RelasjonMedIder relasjonMedIder = (RelasjonMedIder) o;
    return Objects.equals(this.vegobjekter, relasjonMedIder.vegobjekter) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class RelasjonMedIder {\n");
