...
public enum InkluderGeometri {
  ...
  @JsonCreator
  public static InkluderGeometri fromValue(String value) {
    for (InkluderGeometri b : InkluderGeometri.values()) {
