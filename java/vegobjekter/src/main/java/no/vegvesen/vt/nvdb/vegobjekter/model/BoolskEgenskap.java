 ...
 */
@JsonPropertyOrder({
  BoolskEgenskap.JSON_PROPERTY_VERDI
})
...
public class BoolskEgenskap extends Egenskap {
  public static final String JSON_PROPERTY_VERDI = "verdi";
  @jakarta.annotation.Nullable
  private Boolean verdi;

  public BoolskEgenskap() {

  }

  public BoolskEgenskap verdi(@jakarta.annotation.Nullable Boolean verdi) {
  ...
  @JsonProperty(value = JSON_PROPERTY_VERDI, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setVerdi(@jakarta.annotation.Nullable Boolean verdi) {
    this.verdi = verdi;
  }


  @Override
  public BoolskEgenskap id(@jakarta.annotation.Nonnull Integer id) {
    this.setId(id);
    return this;
  }

  @Override
  public BoolskEgenskap navn(@jakarta.annotation.Nonnull String navn) {
    this.setNavn(navn);
    return this;
  }

  @Override
  public BoolskEgenskap egenskapstype(@jakarta.annotation.Nonnull Egenskapstype egenskapstype) {
  ...
  public boolean equals(Object o) {
    ...
    BoolskEgenskap boolskEgenskap = (BoolskEgenskap) o;
    return Objects.equals(this.verdi, boolskEgenskap.verdi) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class BoolskEgenskap {\n");
