...
public class StatistikkApi {
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec getVegobjekterStatistikkMedTyperRequestCreation(@jakarta.annotation.Nullable Set<String> inkluder, @jakarta.annotation.Nullable Set<String> kontraktsomrade, @jakarta.annotation.Nullable LocalDate tidspunkt) throws WebClientResponseException {
        Object postBody = null;
        // create path and map variables
        final Map<String, Object> pathParams = new HashMap<String, Object>();
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Flux<VegobjekterStatistikkMedType> getVegobjekterStatistikkMedTyper(@jakarta.annotation.Nullable Set<String> inkluder, @jakarta.annotation.Nullable Set<String> kontraktsomrade, @jakarta.annotation.Nullable LocalDate tidspunkt) throws WebClientResponseException {
        ParameterizedTypeReference<VegobjekterStatistikkMedType> localVarReturnType = new ParameterizedTypeReference<VegobjekterStatistikkMedType>() {};
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<ResponseEntity<List<VegobjekterStatistikkMedType>>> getVegobjekterStatistikkMedTyperWithHttpInfo(@jakarta.annotation.Nullable Set<String> inkluder, @jakarta.annotation.Nullable Set<String> kontraktsomrade, @jakarta.annotation.Nullable LocalDate tidspunkt) throws WebClientResponseException {
        ParameterizedTypeReference<VegobjekterStatistikkMedType> localVarReturnType = new ParameterizedTypeReference<VegobjekterStatistikkMedType>() {};
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public ResponseSpec getVegobjekterStatistikkMedTyperWithResponseSpec(@jakarta.annotation.Nullable Set<String> inkluder, @jakarta.annotation.Nullable Set<String> kontraktsomrade, @jakarta.annotation.Nullable LocalDate tidspunkt) throws WebClientResponseException {
