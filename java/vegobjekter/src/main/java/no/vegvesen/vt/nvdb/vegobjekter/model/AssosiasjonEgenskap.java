 ...
 */
@JsonPropertyOrder({
  AssosiasjonEgenskap.JSON_PROPERTY_VERDI
})
...
public class AssosiasjonEgenskap extends Egenskap {
  public static final String JSON_PROPERTY_VERDI = "verdi";
  @jakarta.annotation.Nullable
  private Long verdi;

  public AssosiasjonEgenskap() {

  }

  public AssosiasjonEgenskap verdi(@jakarta.annotation.Nullable Long verdi) {
  ...
  @JsonProperty(JSON_PROPERTY_VERDI)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setVerdi(@jakarta.annotation.Nullable Long verdi) {
    this.verdi = verdi;
  }


  @Override
  public AssosiasjonEgenskap id(@jakarta.annotation.Nonnull Integer id) {
    this.setId(id);
    return this;
  }

  @Override
  public AssosiasjonEgenskap navn(@jakarta.annotation.Nonnull String navn) {
    this.setNavn(navn);
    return this;
  }

  @Override
  public AssosiasjonEgenskap egenskapstype(@jakarta.annotation.Nonnull EgenskapstypeEnum egenskapstype) {
  ...
  public boolean equals(Object o) {
    ...
    AssosiasjonEgenskap assosiasjonEgenskap = (AssosiasjonEgenskap) o;
    return Objects.equals(this.verdi, assosiasjonEgenskap.verdi) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class AssosiasjonEgenskap {\n");
