...
/**
 * Gets or Sets InkluderIEgenskaper
 */
public enum InkluderIEgenskaper {
  ...
  InkluderIEgenskaper(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static InkluderIEgenskaper fromValue(String value) {
    for (InkluderIEgenskaper b : InkluderIEgenskaper.values()) {
