...
public class Sideanlegg {
  ...
  public Sideanlegg retning(@jakarta.annotation.Nonnull RetningEnum retning) {
  ...
  public Sideanlegg trafikantgruppe(@jakarta.annotation.Nonnull TrafikantgruppeEnum trafikantgruppe) {
